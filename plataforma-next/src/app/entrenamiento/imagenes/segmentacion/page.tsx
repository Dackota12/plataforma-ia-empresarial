...
export default function SegmentacionPage() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <h1 className="text-2xl font-bold mb-2">Segmentación de Imágenes</h1>
      <p className="text-gray-600 mb-4">Carga imágenes para entrenar un modelo de segmentación.</p>
      ...
      {files.length > 0 && (
        <>
          ...
          <Button className="mt-6">Agregar máscaras/segmentaciones</Button>
        </>
      )}
      <Button
  variant="secondary"
